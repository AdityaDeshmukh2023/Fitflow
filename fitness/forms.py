    ...
    class Meta:
        ...
        widgets = {
            ...
            "weight": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Weight in kg"}
            ),
            "height": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Height in cm"}
            ),
            ...
            "specific_area": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "e.g., core strength, upper body, legs",
                }
            ),
            "target_timeline": forms.TextInput(
                attrs={
                    "class": "form-control",
            ...
            "injuries_or_physical_limitation": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
            ...
            "exercise_setting": forms.Select(attrs={"class": "form-control"}),
            "available_equipment": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
